...
echo "Comparing syn ground truth outputs to new processor"
cd .
...
result_file="syn_all_results.txt"
> "$result_file"
...
echo "Synthesis Total Passed: $pass_count out of $total_count" | tee -a "$result_file"
