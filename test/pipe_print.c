...
void print_header(char* str) {
    if (ppfile == NULL) ppfile = fopen("pipeline.out", "w");
...
//         printf( "%d", proc2mem_addr_lo);
//     else
//         printf( "0x%x%x", proc2mem_addr_hi, proc2mem_addr_lo);
...
//             printf( "%d", proc2mem_data_lo);
//         else
//             printf( "0x%x%x", proc2mem_data_hi, proc2mem_data_lo);
//     }
//     if (mem2proc_response) {
//         printf( " accepted %d", mem2proc_response);
//     } else {
//         printf( " rejected");
//     }
// }
